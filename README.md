...
Example of use on sample data:

```sh
python3 main.py fit LinearJobOffersClassifier -x train_test_data/example/x_train.txt -y train_test_data/example/y_train.txt -h train_test_data/example/classes.tsv -m example_model
```
